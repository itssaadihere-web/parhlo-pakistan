...
const STAGES = [
  ...
  { id: 'signed_in', label: 'Signed In', color: 'bg-cyan-100 text-cyan-800 border-cyan-200' },
  { id: 'converted', label: 'Converted (Paid)', color: 'bg-emerald-100 text-emerald-800 border-emerald-200' },
